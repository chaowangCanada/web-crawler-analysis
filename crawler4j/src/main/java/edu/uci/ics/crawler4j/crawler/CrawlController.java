...
public class CrawlController extends Configurable {
	...
	static final Logger logger = Logger.getLogger(CrawlController.class
			.getName());
	...
	/**
	 * This method is called everytime the main thread checks if the Threads are
	 * still active. (e.g. every 3 or 10 seconds)
	 */
