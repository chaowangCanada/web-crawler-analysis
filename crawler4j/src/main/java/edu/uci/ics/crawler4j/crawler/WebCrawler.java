...
public class WebCrawler implements Runnable {
	...
	/**
	 * Returns the time to wait before fetching the given URL.
	 * Must Return zero if we don't have to Sleep.
	 * @param url
	 * @return
	 */
	...
	// this method is not processed in the HttpCrawler4j project, it is
	// overwritten in HttpAnalysisCrawler
